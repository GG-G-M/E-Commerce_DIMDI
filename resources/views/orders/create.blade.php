...
@section('content')
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('cart.index') }}" class="btn-outline-modern"
                        style="width: auto; min-height: auto; padding: 0.5rem 1rem; font-size: 0.85rem;">
                                ...
                                <div id="paymongo-section" class="payment-section" style="display: none;">
                                    ...
                                    <div id="gcash-payment" class="payment-method" style="display: none;">
                                        <div class="text-center">
                                            ...
                                            <p>You will be redirected to GCash to complete your payment after placing the
                                                order.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div id="grabpay-payment" class="payment-method" style="display: none;">
                                        <div class="text-center">
                                            ...
                                            <p>You will be redirected to GrabPay to complete your payment after placing the
                                                order.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @php
                                    ...
                                    if ($hasVariants && $item->selected_size) {
                                        ...
                                        if ($variant) {
                                            ...
                                            $variantName =
                                                $variant->size ?? ($variant->variant_name ?? $item->selected_size);
                                        } else {
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @if ($hasDiscount && $originalUnitPrice > $unitPrice)
                                                <span
                                                    style="color: var(--primary-green); font-weight: 600;">₱{{ number_format($unitPrice, 2) }}</span>
                                                <small class="text-muted"
                                                    style="text-decoration: line-through;">₱{{ number_format($originalUnitPrice, 2) }}</small>
                                    ...
                                    <div class="product-total">
                                        @if ($hasDiscount && $itemOriginalTotalPrice > $itemTotalPrice)
                                            <div>
                                                ...
                                                <div>
                                                    <small class="text-muted"
                                                        style="text-decoration: line-through;">₱{{ number_format($itemOriginalTotalPrice, 2) }}</small>
                                                </div>
                                            </div>
                                        @else
                                            ₱{{ number_format($itemTotalPrice, 2) }}
        ...
        @else
            ...
            <div class="empty-state">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('profile.show') }}" class="btn-primary-modern"
                        style="width: auto; min-height: auto; padding: 0.75rem 1.5rem;">
    ...
    <script>
        ...
        function updateShippingDisplay(shippingFee, zoneName, details) {
            ...
            document.getElementById('display-shipping').textContent = '₱' + shippingFee.toLocaleString('en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });
            document.getElementById('display-total').textContent = '₱' + total.toLocaleString('en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });

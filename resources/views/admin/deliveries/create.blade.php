...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h1 class="h3 mb-1">Add Delivery Person</h1>
        <p class="text-muted mb-0">Create new delivery personnel account</p>
    </div>
...
<div class="card card-custom">
    <div class="card-header card-header-custom">
        <i class="fas fa-user-plus me-2"></i> Delivery Person Details
    </div>
    <div class="card-body">

            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p class="hero-subtitle">Premium appliances and furniture designed to elevate your home experience
                            with style, comfort, and innovation.</p>
                        <a href="{{ route('products.index') }}" class="btn btn-hero">Shop Now <i
                                class="fas fa-arrow-right ms-2"></i></a>
                    </div>
                    <div class="col-lg-6 text-center">
                        <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        ...
                        <p class="about-text">Since 2010, DIMDI has been transforming homes across the country with our
                            carefully curated selection of premium appliances and furniture. We believe that your home
                            should be a reflection of your personality and a sanctuary for your family.</p>
                        <p class="about-text">Our mission is to provide high-quality, durable products that combine
                            innovative design with practical functionality, ensuring your home is both beautiful and
                            comfortable.</p>
                        ...
                        <div class="about-feature">
                            ...
                            <div>
                                ...
                                <p class="text-muted">All our products undergo rigorous quality checks and come with
                        ...
                        <div class="about-feature">
                            ...
                            <div>
                                <h5>Expert Team</h5>
                                <p class="text-muted">Our design consultants help you choose the perfect pieces for your
                                    space and style.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img src="https://images.unsplash.com/photo-1555041469-a586c61ea9bc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                            alt="About DIMDI" class="img-fluid rounded-3 shadow">
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="card product-card h-100">
                                @if ($product->has_discount)
                                    <span class="discount-badge badge bg-danger">{{ $product->discount_percentage }}%
                                        OFF</span>
                                @endif
                                        ...
                                        @if ($product->in_stock)
                                            <form action="{{ route('cart.store') }}" method="POST"
                                                ...
                                                @if ($product->has_variants && $product->variants->count() > 0)
                                                    <div class="mb-2">
                                                        <select name="selected_size" class="form-select form-select-sm"
                                                            required>
                ...
                <div class="row mt-5">
                    <div class="col-12 text-center">
                        <a href="{{ url('/products') }}" class="btn btn-outline-primary btn-lg"
                            style="border-color: var(--primary-green); color: var(--primary-green);">View All Products <i
                                class="fas fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-12 text-center">
                        ...
                        <p class="lead text-muted">With over 15 years of excellence in home solutions, we've built our
                            reputation on quality and customer satisfaction</p>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <p class="feature-text">All our products come with industry-leading warranty coverage, giving
                                you peace of mind for years to come.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <p class="feature-text">We offer complimentary delivery and professional installation services
                                for all orders over $500.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <p class="feature-text">Our dedicated customer support team is available around the clock to
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <p class="feature-text">We carefully select each item in our collection for durability,
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <p class="feature-text">With 25+ locations across the country, we're never far away when you
                                need us.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="feature-card">
                            ...
                            <p class="feature-text">Not completely satisfied? We offer straightforward returns within 30
                                days of purchase.</p>
                        </div>
                    </div>
                </div>
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    fetch(this.action, {
                        ...
                        .catch(error => {
                            ...
                            showToast('Unable to add product to cart. Please try again.',
                                'error');
                        })
                        .finally(() => {

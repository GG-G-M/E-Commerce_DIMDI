...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h3 mb-1" style="color: #2C8F0C; font-weight: 700;">Add New Product</h1>
            <p class="mb-0 text-muted">Create a new product for your store catalog</p>
        </div>
    </div>
</div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="image-upload-area">
                            ...
                            <p class="mb-2">Click to upload product image</p>
